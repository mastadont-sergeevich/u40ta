...
exports.AppEventsModule = AppEventsModule = __decorate([
    (0, common_1.Module)({
        providers: [app_events_service_1.AppEventsService],
        controllers: [app_events_controller_1.AppEventsController],
        exports: [app_events_service_1.AppEventsService],
    })
], AppEventsModule);
